...
export const escenas = {
  ...
  e88: {
    ...
    markers: [
      {
        id: 'e88-a-e140',
        position: { yaw: '314.58deg', pitch: '0.35deg' },
        html: gifHTML('e140'),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
      {
        id: 'e88-a-e144',
        position: { yaw: '21.35deg', pitch: '33.82deg' },
        html: gifHTML('e144', null, iconoAerea),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
      {
        id: 'e88-a-e141',
        position: { yaw: '70.82deg', pitch: '-0.74deg' },
        html: gifHTML('e141'),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
  ...
  e144: {
    panorama: 'fotos/Aereas/144.jpg',
    defaultYaw: '54.18deg',
    defaultPitch: '-39.30deg',
    markers: [],
  },
  e140: {
    panorama: 'fotos/AquaKids/140.jpg',
    defaultYaw: '58.41deg',
    defaultPitch: '-2.33deg',
    markers: [
      {
        id: 'e140-a-e141',
        position: { yaw: '58.41deg', pitch: '-2.33deg' },
        html: gifHTML('e141'),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
      {
        id: 'e140-a-e88',
        position: { yaw: '150.85deg', pitch: '-0.20deg' },
        html: gifHTML('e88'),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
      {
        id: 'e140-a-e144',
        position: { yaw: '106.21deg', pitch: '24.67deg' },
        html: gifHTML('e144', null, iconoAerea),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
  ...
  e141: {
    panorama: 'fotos/AquaKids/141.jpg',
    defaultYaw: '180.58deg',
    defaultPitch: '-1.79deg',
    markers: [
      {
        id: 'e141-a-e88',
        position: { yaw: '183.14deg', pitch: '-0.10deg' },
        html: gifHTML('e88'),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
      {
        id: 'e141-a-e140',
        position: { yaw: '273.70deg', pitch: '-0.78deg' },
        html: gifHTML('e140'),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
      {
        id: 'e141-a-e144',
        position: { yaw: '232.22deg', pitch: '31.27deg' },
        html: gifHTML('e144', null, iconoAerea),
        size: { width: 320, height: 50 },
        anchor: 'left center',
      },
  ...
  e142: {
    panorama: 'fotos/AquaKids/142.jpg',
    defaultYaw: '0deg',
    defaultPitch: '0deg',
    markers: [],
  },
